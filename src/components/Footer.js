                    ...
                    <div className="col-4 offset-1">
                        <form>
                            ...
                            <div className="d-flex w-100 gap-2">
                                ...
                                <input id="newsletter1" type="text" className="form-control" placeholder="Email address" fdprocessedid="1u4qjm" />
                                <button className="btn btn-primary" type="button" fdprocessedid="sebx28">Subscribe</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div className="d-flex justify-content-between py-4 my-4 border-top">
                    <p>© 2023 HomeFood, Inc. All rights reserved.</p>
